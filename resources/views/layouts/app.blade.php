...
<body>
    <button id="toggleSidebarBtn" class="btn btn-dark btn-sm"
                ...
                <ul class="text-center space-y-2">
                    @auth
                        <li class="title-sidebar">
                            <a href="{{ route('home') }}"
                                ...
                                <span><img src="{{ asset('images/innovalogo.png') }}" alt=""
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul id="pesos-menu" class="submenu">
                                <li>
                                    <a href="{{ route('pesos.index') }}"
                                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                        <div class="sidebar-box">
                                            <span class="ms-3 whitespace-nowrap"><button class="link-sidebar-btn">
                                                    BALANZA</button></span>
                                        </div>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('lotizacion') }}"
                                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                        <div class="sidebar-box">
                                            <span class="ms-3 whitespace-nowrap"><button
                                                    class="link-sidebar-btn">LOTIZACION</button></span>
                                        </div>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('ingresos.index') }}"
                                        ...
                                        <div class="sidebar-box">
                                            <span class="ms-3 whitespace-nowrap"><button
                                                    class="link-sidebar-btn">INGRESOS</button></span>
                                        </div>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('blendings.index') }}"
                                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                        <div class="sidebar-box">
                                            <span class="ms-3 whitespace-nowrap"><button class="link-sidebar-btn">
                                                    BLENDINGS</button></span>
                                        </div>
                                    </a>
                                </li>
                                <li>
                            ...
                            <ul id="liquidaciones-menu" class="submenu">
                                ...
                                <li>
                                    <a href="{{ route('facturas.index') }}"
                                        ...
                                        <div class="sidebar-box">
                                            <span class="ms-3 whitespace-nowrap"><button class="link-sidebar-btn">
                                                    ADELANTOS</button></span>
                                        </div>
                                    </a>
                                </li>
                                <!-- <li>
                                            <a href="{{ route('adelantos.index') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                                <div class="sidebar-box">
                                        ...
                                        <li>
                                            <a href="{{ route('resumens.index') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                                <div class="sidebar-box">
                                                    <span class="ms-3 whitespace-nowrap"><button class="link-sidebar-btn"> RESUMEN ADEL.</button></span>
                                                </div>
                                            </a>
                                        </li>-->
                                <li>
                                    <a href="{{ route('liquidaciones.index') }}"
                                        ...
                                        <div class="sidebar-box">
                                            <span class="ms-3 whitespace-nowrap"><button class="link-sidebar-btn">
                                                    VALORIZACION</button></span>
                                        </div>
                                    </a>
                                </li>

                                <li>
                                    <a href="{{ route('procesadas') }}"
                                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                        <div class="sidebar-box">
                                            <span class="ms-3 whitespace-nowrap"><button class="link-sidebar-btn">
                                                    FINA</button></span>
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul id="inventario-menu" class="submenu">
                                ...
                                <li>
                                    <a href="{{ route('accategorias.index') }}"
                                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                        <div class="sidebar-box">
                                            <span class="ms-3 whitespace-nowrap"><button class="link-sidebar-btn">
                                                    CATEGORÍAS</button></span>
                                        </div>
                                    </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="{{ route('empleados.index') }}"
                                        ...
                                        <div class="sidebar-box">
                                            <span class="ms-3 whitespace-nowrap"><button class="link-sidebar-btn">
                                                    EMPLEADOS</button></span>
                                        </div>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('posiciones.index') }}"
                                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                        <div class="sidebar-box">
                                            <span class="ms-3 whitespace-nowrap"><button class="link-sidebar-btn">
                                                    POSICIONES</button></span>
                                        </div>
                                    </a>
                                </li>
                            </ul>
                        ...
                        <li>
                            <a href="#"
                                ...
                                <div class="sidebar-box">
                                    <span class="ms-3 whitespace-nowrap"><button class="link-sidebar-btn"> CERRAR
                                            SESIÓN</button></span>
                                </div>
                            </a>
                    ...
                    @if (!Auth::check())
                        <div style="text-align: center;">
                            <img src="{{ asset('images/innovalogo.png') }}" alt=""
                                style="width:200px; height:200px; vertical-align:middle; margin-bottom: 20px;">
                            <p style="font-size: 30px; font-family: 'Arial', sans-serif; margin-top: 10px;">INNOVA
                                CORPORATIVO</p>
                        </div>
                    @endif
                </ul>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#buscar_dniencargado_btn').click(function() {
                buscarDocumento('{{ route('buscar.documento') }}', '#documento_encargado',
                    '#datos_encargado');
            })
