...
<head>
    <meta charset="utf-8">
    <title>Acta — {{ $liquidacion->id ?? '—' }}</title>
        ...
        <div class="doc">
            ...
            <div class="box" style="margin-bottom:10px;">
                <p>En la localidad de <b>Nasca</b>, siendo las <b>{{ $liquidacion->created_at->format('H:i') }}</b>
                    ...
                    de la entrega,
                    traslado, recepción y verificación del concentrado, de acuerdo con la normativa vigente que regula
                    su
                ...
                <div class="box">
                    ...
                    <table class="kv">
                        ...
                        <tr>
                            ...
                            <td class="value">Carretera Pampa de Chauchilla km 1, Fundo Santa Cirila, Ica - Nasca</td>
                        </tr>
                    </table>
                </div>
            </div>
            ...
            <div class="box">
                <p>1. La entrega del concentrado con origen de <b>{{ $liquidacion->ingreso->procedencia ?: '—' }}</b> ,
                    se realizó en el
            ...
            <div class="box" style="margin-top:15px;">
                <p>Firmado en la ciudad de <b>Nasca</b>, a los <b>{{ $liquidacion->created_at->format('d') }}</b> días
                    del mes de
