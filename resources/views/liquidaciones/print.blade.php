        ...
        <div class="header">
            ...
            @if ($liquidacion->igv2 > 0)
                <div class="header-right">
                     <div class="meta">
                        <span style="font-size:10px; color:#555;">N°</span>
                        <strong style="font-size:10px; color:#555;">#{{ $liquidacion->id ?? '—' }}</strong>
                    </div>
                    <img src="{{ asset('images/inn.jpg') }}" alt="Logo" class="header-logo">
        ...
        <div class="content">
            <div class="section">
                <div class="data-box">
                    <div class="left">
                        ...
                        <p></p>
                        <p><strong>FECHA INGRESO LOTE:</strong> {{ $liquidacion->fechai }} <strong> FECHA
                                CIERRE:</strong> {{ $liquidacion->updated_at }} <strong>CERRADO POR: </strong>
                            <td>
                                {{ $liquidacion->lastEditor ? explode(' ', $liquidacion->lastEditor->name)[0] : 'N/A' }}
                            </td>
                        </p>
                        <p><strong>N° Ticket:</strong> {{ $liquidacion->NroSalida }} <strong> Guía de
                                Transporte:</strong> {{ $liquidacion->ingreso->guia_transporte ?? '' }} <strong>Guía de
                                Remisión:</strong> {{ $liquidacion->ingreso->guia_remision ?? '' }}</p>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><strong>$</strong>{{ $liquidacion->maquila2 > 0 ? $liquidacion->maquila2 : '' }}
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td><strong>$</strong>{{ $liquidacion->division > 0 ? $liquidacion->division : '' }}
                            </td>
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td>{{ $liquidacion->resultadoestibadores > 0 ? $liquidacion->resultadoestibadores : '' }}
                            </td>
                            <td><strong>$</strong>{{ $liquidacion->resultadoestibadores > 0 ? $liquidacion->resultadoestibadores : '' }}
                            </td>
                        </tr>
                        <tr>
                            <td class="highlighted-text" contenteditable="true">MOLIENDA</td>
                            <td></td>
                            <td>{{ $liquidacion->resultadomolienda > 0 ? $liquidacion->resultadomolienda : '' }}
                            </td>
                            <td><strong>$</strong>{{ $liquidacion->resultadomolienda > 0 ? $liquidacion->resultadomolienda : '' }}
                            </td>
                        ...
                        <tr>
                            ...
                            <td><strong>$</strong>{{ $liquidacion->transporte > 0 ? $liquidacion->transporte : '' }}
                            </td>

                        </tr>
                        <tr>
                            <td colspan="3" class="highlighted-text"><strong>TOTAL DEDUCCIONES:</strong></td>
                            <td class="highlighted-text"><strong>$</strong>{{ $liquidacion->total_deducciones }}
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="highlighted-text"><strong>$</strong>{{ $liquidacion->total_penalidades }}
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="highlighted-text"><strong>$</strong>{{ $liquidacion->total_liquidacion }}
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div class="combined-table" id="seccion-datos-adicionales" style="display:none;">
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td class="highlighted-text">PROCESO DE PLANTA</td>
                            <td class="text-right">$ {{ $liquidacion->procesoplanta }}</td>
                        </tr>
                        <tr>
                            <td class="highlighted-text">ADELANTOS</td>
                            <td class="text-right">$ {{ $liquidacion->adelantosextras }}</td>
                        </tr>
                        <tr>
                            <td class="highlighted-text">PRESTAMOS</td>
                            <td>$ {{ $liquidacion->prestamos }}</td>
                        </tr>
                        <tr>
                            <td class="highlighted-text">OTROS DESCUENTOS</td>
                            <td>$ {{ $liquidacion->otros_descuentos }}</td>
                        </tr>
